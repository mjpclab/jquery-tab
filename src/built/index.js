...
$.fn.tab = function (customOptions) {
    ...
    const generateStructure = function ($item) {
        ...
        //top label
        let $topLabelContainer;
        let $topLabelContainerLeaf;
        ...
        //add labels & pages
        const newLabelItem = function (title) {
        ...
        const newPageItem = function (content) {
        ...
        const saveIndex = function (index) {
        ...
        //methods
        const _updateClass = function ($activeLabelItem, $activePageItem) {
        ...
        const _insertTabPage = function (title, content, index) {
        ...
        const insertTabPage = function (title, content, index) {
            _insertTabPage(title, content, index);
            if (currentIndex === -1 && pageCount) {
                switchTo(0);
            }
        };
        const addTabPage = function (title, content) {
